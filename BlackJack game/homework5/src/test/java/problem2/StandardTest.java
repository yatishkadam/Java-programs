...
/**
 * this Test class is used to test the standard deck.
 */
class StandardTest {
    ...
    private static final int MAXSPADESINDECK = 13;
    private static final int MAXHEARTINDECK = 13;
    private static final int MAXCLUBSINDECK = 13;
    private static final int MAXDIMONDINDECK = 13;

    private int maxSameSuitCards = 13;
    private static final int MAXNUMBEROFSAMERANK = 4;

    private int maxNumberOfSameSuitedRank = 1;
    ...
    void initDeck(){
         ...
         */
        deck = DeckFactory.createDeck("Standard");
    ...
    @Test
    void officialSize() {
        assertEquals(deck.officialSize(), standardDeckSize);
    }
    ...
    void sortByRank(){
        ...
        while (actualIndex < standardDeckSize){
    ...
    void sortByBoth(){
        ...
        while ( i < standardDeckSize){
            ...
            for (int j = i ; j < i + maxSameSuitCards;j+= maxNumberOfSameSuitedRank){
                ...
                assertEquals(suitOfCard, suitToCheck);
                assertEquals(shortName, cardOrderToCheck);
                indexOfOrder +=1;
            }
            i+=maxSameSuitCards;
            suitIndex +=1;
    ...
    void pullCard() {
        ...
        assertEquals(deck.getCards().size(), (standardDeckSize -1)); // check if the deck size shrank by 1
    }
